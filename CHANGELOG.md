...
This repo's older, pre-version prose log lives at `docs/changelog.md` and is
retired/read-only. This file answers one question only: *what does a given
`BUILD_VERSION` actually do differently, at runtime, from the last one.*
