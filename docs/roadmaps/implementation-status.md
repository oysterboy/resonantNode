...
| Automated tests / CI | planned | One Unity suite (`test_analyzer_pass_rules`), on-device only. No native env, no CI; every cleanup phase since 2026-09-20 is compile-verified only. See NODE-006 / NODE-007. |
