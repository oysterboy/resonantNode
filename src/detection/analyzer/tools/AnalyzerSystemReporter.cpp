...
void AnalyzerApp::printSystemHealth(const AnalyzerReport& report) const {
    ...
    if (!compactHealth) {
        ...
        Serial.print(" evaluator_drain_count=");
        Serial.print(_detection.evaluatorDrainCount());
        ...
        Serial.print(" evaluator_accept_attempt_count=");
        Serial.print(_detection.evaluatorAcceptAttemptCount());
        Serial.print(" evaluator_accept_success_count=");
        Serial.print(_detection.evaluatorAcceptSuccessCount());
        Serial.print(" evaluator_accept_reject_count=");
        Serial.print(_detection.evaluatorAcceptRejectCount());
        Serial.print(" verdict_produced_count=");
        Serial.print(_detection.verdictProducedCount());
        Serial.print(" verdict_event_pushed_count=");
        Serial.print(_detection.verdictEventPushedCount());
        Serial.print(" verdict_event_dropped_count=");
        Serial.print(_detection.verdictEventDroppedCount());
        Serial.print(" evaluator_latest_reject_reason=");
        Serial.print(detection::evaluatorInputRejectReasonName(_detection.latestEvaluatorInputRejectReason()));
    }
    Serial.println();
    _loopHealth.reset();
    ...
    Serial.print("I2S_IO_HEALTH");
    Serial.print(" reads=");
    Serial.print(sourceStats.reads);
    Serial.print(" bytes=");
    Serial.print(sourceStats.readBytes);
    Serial.print(" zero_reads=");
    Serial.print(sourceStats.zeroReads);
    Serial.print(" short_reads=");
    Serial.print(sourceStats.shortReads);
    Serial.print(" max_read_bytes=");
    Serial.print(sourceStats.maxReadBytes);
    Serial.print(" read_errors=");
    Serial.print(sourceStats.readErrors);
    Serial.print(" overflow=");
    Serial.print(sourceStats.overflowCount);
    Serial.print(" total_samples=");
    Serial.println(static_cast<unsigned long long>(sourceStats.totalSamplesRead));
}
